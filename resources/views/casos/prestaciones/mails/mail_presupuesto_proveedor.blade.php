...
<div class="container-fluid">
    <div class="row">
        <div class="col-xs-10 col-xs-offset-1 mb-20">
            ...
            <p class="text-right">Ref. Orden 93 - Subsidio {{$pres->first()->Pedido->Prestacion->Casos->id}} - <b class="upper">{{$pres->first()->Pedido->Prestacion->Casos->PersonasFisicas->fullname}} - @if(isset($pres->first()->Compulsas)) {{$pres->first()->Compulsas->nro_expediente}} @endif</b></p>
    ...
    <div class="row">
        <div class="col-xs-10 col-xs-offset-1">
            ...
            <div class="border">
                <p class="upper">hasta el día <b></b> a las <b></b> se recibirán los sobres y el día <b></b> a las <b></b> se abrirán los mismos, en esta dirección de ayuda a personas, sitio en la calle avenida de mayo 869 piso 8² mesa de entradas, capital federal (cod. postal 1002).</p>
            </div>
        ...
        <div class="col-xs-10 col-xs-offset-1">
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td>{{$pres->first()->Pedido->Prestacion->Casos->id}}</td>
                </tr>
                <tr>
                    <th class="upper">Paciente</th>
                    <td class="upper">{{$pres->first()->Pedido->Prestacion->Casos->PersonasFisicas->fullname}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="upper">Buenos Aires</td>
                </tr>
                </tbody>
    ...
    <div class="row">
        <div class="col-xs-10 col-xs-offset-1">
            <table class="table table-striped table-hover">
                ...
                @foreach($pres as $p)
                <tr>
                    <td class="upper">{{$p->id}}</td>
                    <td>{{$p->Pedido->Prestacion->id}}</td>
                    <td>{{$p->Pedido->cantidad_solicitada}}</td>
                    <td>{{$p->Pedido->Prestacion->descripcion}}</td>
                </tr>
                @endforeach
                </tbody>
